...
local Miss = pss:GetTapNoteScores("TapNoteScore_Miss") + pss:GetTapNoteScores("TapNoteScore_W5") + pss:GetHoldNoteScores("HoldNoteScore_MissedHold") + pss:GetHoldNoteScores("HoldNoteScore_LetGo")
